                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control @error('icon') is-invalid @enderror" id="icon" name="icon" value="{{ old('icon') }}" placeholder="e.g. bi-house-door">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('route') is-invalid @enderror" id="route" name="route" value="{{ old('route') }}" placeholder="e.g. dashboard">
                            @error('route')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="mb-3">
                                ...
                                <select class="form-select select2 @error('list_permissions') is-invalid @enderror" id="list_permissions" name="list_permissions[]" multiple>
                                    ...
                                    @foreach($access as $permission)
                                        <option value="{{ $permission }}" {{ in_array($permission, old('list_permissions', [])) ? 'selected' : '' }}>
                                            {{ $permission }}
                                        </option>
                                    @endforeach
                                </select>
